<template>
    <div class="mainViewer">
        ...
        <img :src="imageSrc" :class="class" :id="'img_'+id" :alt="imageName" @error="imageLoadError" @click="openEditorImage"/>
...
.mainViewer > img{
    ...
    border-radius: .5rem;
    object-fit: cover;
    max-width: max(50%,300px); /* set the max-width of img to whichever value is largest, 50% or 300px: */
}
.mainViewer > img:hover{ cursor: move; margin: .4rem; transition: .2s; }
...
.mainViewer > span::first-line{ line-height: 2rem; font-weight: bolder; margin: 2rem 0; }
.mainViewer > span > li{
