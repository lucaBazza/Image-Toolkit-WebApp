<template>
  <p class="catalogOwner" @click="openUserSettings">
    👤 {{ initialCatalog.catalogOwner }}
  </p>
...
eventEmitter.on("toggleDarkMode", () => {
  ...
  const hasDarkMode = document.body.classList.contains("darkMode")
    ? "-darkMode"
    : "";
...
export default defineComponent({
  ...
  methods: {
    ...
    openUserSettings() {
      this.showLogInArea = !this.showLogInArea;
